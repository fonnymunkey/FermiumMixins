...
public abstract class ItemRenderer_DeathShakeMixin {
    ...
    private float fermiummixins_vanillaItemRenderer_rotateArm_store3(float value) {
    ...
    private float fermiummixins_vanillaItemRenderer_rotateArm_store4(float value) {
