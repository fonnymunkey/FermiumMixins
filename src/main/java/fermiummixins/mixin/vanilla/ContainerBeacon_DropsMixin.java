...
public abstract class ContainerBeacon_DropsMixin {
	...
	private boolean fermiummixins_vanillaContainerMerchant_containerClosed(EntityPlayer player, ItemStack stack, boolean unused) {
