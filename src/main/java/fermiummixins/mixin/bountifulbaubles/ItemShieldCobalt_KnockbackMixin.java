...
public abstract class ItemShieldCobalt_KnockbackMixin {
    ...
    private double fermiummixins_bountifulBaublesItemShieldCobalt_getAttributeModifiers(double constant) {
        return 1000.0;
    }
    ...
    private static double fermiummixins_bountifulBaublesItemShieldCobalt_clinit(double constant) {
        return 1000.0;
    }
}