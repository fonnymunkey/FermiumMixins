...
public class BetterNetherHandler_CrashMixin {
    ...
    private static boolean fermiummixins_netherAPIBetterNetherHandler_registerBiomes_setAdd(Set<NetherBiome> instance, Object biome) {
        return biome != null;
    }
    ...
    private static boolean fermiummixins_netherAPIBetterNetherHandler_registerBiomes_consumerAccept(ObjIntConsumer<NetherBiome> instance, Object biome, int biomeId) {
        return biome != null;
    }
}